...
/// Base game object
///
/// Due to how league's game objects are implemented and to achieve good
/// performance reading game objects this class doesnt use inheritance instead
/// it packs all the types together in this class
